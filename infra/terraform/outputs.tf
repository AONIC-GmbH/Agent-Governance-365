...
output "next_steps" {
  value = <<-EOT
    ...
    9. Nightly Logic App (if enabled) GETs INTERNAL-JOB-TRIGGER-SECRET then POSTs inventory_sync only. Add extra POSTs in the designer for Power BI or Copilot Kit — see DEPLOYMENT.md §5.3.
  EOT
}
